...
(function () {
  ...
  function defaultState() {
    return {
      ...
      patient:   { id:'sarah',  name:'Chen V', initials:'CV', tags:['PTSD','Sleep','Veteran (IDF)'], age:34, pronouns:'he/him', sinceLabel:'Patient since Nov 2025', sinceLabelShort:'6 months' },
      tagLibrary: [
        { label:'PTSD',          color:'amber', patients:1 },
        { label:'Sleep',         color:'blue',  patients:1 },
        { label:'Veteran (IDF)', color:'green', patients:1 },
      ],
      compliance: { value: 82, deltaLabel: '+6 last 7 days', sparkline: [62,65,68,66,71,74,72,75,78,76,80,82] },
      ...
      sessions: [
        { id:'s9',  num:9,  date:'May 2 ',  duration:'47 min', src:'Google Meet', stages:{raw:true,note:true,assessment:true,plan:true},
          note:{ presenting:'Started Sertraline 50mg; trauma flashbacks after Tuesday meeting.', interventions:'Discussed grounding; scheduled biweekly cadence.', homework:'Daily gratitude journal; breathwork as needed.' },
        ...
        { id:'s10', num:10, date:'May 9 ',  duration:'53 min', src:'Google Meet', stages:{raw:true,note:true,assessment:true,plan:true},
          note:{ presenting:'Sertraline GI side-effects easing; mood lifting slightly.', interventions:'Reinforced sleep hygiene; tracked HRV pattern.', homework:'Continue gratitude; track bedtime regularity.' },
        ...
        { id:'s11', num:11, date:'May 16', duration:'48 min', src:'Google Meet', stages:{raw:true,note:true,assessment:true,plan:true},
          note:{ presenting:'Work deadline week — back to 1am bedtimes, anxious mornings.', interventions:'Box breathing introduced; phone-use boundary planned.', homework:'Box breathing on stress; gratitude continues.' },
          planVersion:'v3', assessmentVersion: 7 },
        { id:'s12', num:12, date:'May 23', duration:'47 min', src:'Google Meet', stages:{raw:true,note:true,assessment:false,plan:false},
          note:{ subjective:'Reports a hard week — work deadline crunch, falling asleep past 1am most nights. Says "I feel wired but exhausted." Gratitude practice has helped on mornings she keeps it; skipped it twice when she was running late. No suicidal ideation; mood described as "flat, not dark."', objective:'Arrived 4 min late, slightly winded. Affect constricted, attention intact. Speech rate elevated early in session, normalized by minute 15. Notable phone-checking behavior (3×) when discussing roommate dynamics. No psychomotor agitation. Engaged with breathwork demo without resistance.', presenting:'Sleep deterioration · increased anxious rumination · phone-related avoidance of evening wind-down. Mood stable. No new safety concerns this session.', interventions:'Reviewed sleep hygiene checklist. Introduced new 21:30 wind-down rule (no screens). Reinforced existing 4-7-8 breathwork prescription as on-demand stress regulator.', homework:'Continue daily gratitude journal. Use breathwork when stress crosses threshold. Re-evaluate sleep timing in 2 weeks.' },
